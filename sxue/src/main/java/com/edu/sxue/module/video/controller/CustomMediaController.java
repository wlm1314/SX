package com.edu.sxue.module.video.controller;
...
public class CustomMediaController extends MediaController {
    ...
    protected View makeControllerView() {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.mymediacontroller, null);
        v.setMinimumHeight(controllerWidth);
        //获取控件
        img_back = (ImageView) v.findViewById(R.id.iv_back);
        mFileName = (TextView) v.findViewById(R.id.tv_filename);
        //缩放控件
        mIvScale = (ImageView) v.findViewById(R.id.iv_scale);

        if (mFileName != null) {
            mFileName.setText(videoname);
        }
        //声音控制
        mVolumeBrightnessLayout = v.findViewById(R.id.rlayout_volume_brightness);
